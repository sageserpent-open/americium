 ...
 * mix in trait <a href="DeprecatedMustMatchers.html"><code>DeprecatedMustMatchers</code></a>.) For example, if you mix <code>DeprecatedShouldMatchers</code> into
 ...
 * as when invalid arguments are passed to the method. With <code>DeprecatedShouldMatchers</code> mixed in, you can
 ...
 * </p>
 */
trait DeprecatedShouldMatchers extends DeprecatedMatchers with ShouldVerb {
  ...
  /**
   * This class is part of the ScalaTest matchers DSL. Please see the documentation for <a href="DeprecatedShouldMatchers.html"><code>DeprecatedShouldMatchers</code></a> or <a href="DeprecatedMustMatchers.html"><code>DeprecatedMustMatchers</code></a> for an overview of
   * the matchers DSL.
   *
   * <p>
   ...
   * Trait <code>DeprecatedShouldMatchers</code> includes implicit conversions from several types, including many structural types, to <code>LengthWrapper</code>.
   * </p>
   *
   * @author Bill Venners
   */
   ...
   * Trait <code>DeprecatedShouldMatchers</code> includes implicit conversions from several types, including many structural types, to <code>SizeWrapper</code>.
   * </p>
   *
   * @author Bill Venners
   */
...
/**
 * Companion object that facilitates the importing of <code>DeprecatedShouldMatchers</code> members as 
 * an alternative to mixing it the trait. One use case is to import <code>DeprecatedShouldMatchers</code> members so you can use
 ...
 * 
 * scala> import org.scalatest.matchers.DeprecatedShouldMatchers._
 * import org.scalatest.matchers.DeprecatedShouldMatchers._
 * 
 ...
 * 	at org.scalatest.matchers.DeprecatedShouldMatchers$ShouldMethodHelper$.shouldMatcher(DeprecatedShouldMatchers.scala:826)
 * 	at org.scalatest.matchers.DeprecatedShouldMatchers$IntShouldWrapper.should(DeprecatedShouldMatchers.scala:1123)
 * 	at .<init>(<console>:9)
 * 	at .<clinit>(<console>)
 * 	at RequestR...
 *
 ...
 * @author Bill Venners
 */
object DeprecatedShouldMatchers extends DeprecatedShouldMatchers
