...
/**
 * <b>MultipleFixtureFlatSpec has been deprecated and will be removed in a future version of ScalaTest.
 * Please use FixtureFlatSpec with ConfigMapFixture instead.</b>
 *
 * <p>
 ...
 * just change "MultipleFixtureFlatSpec" to "FixtureFlatSpec with ConfigMapFixture" in your code. - Bill Venners
 * </p>
 */
@deprecated("Use FixtureFlatSpec with ConfigMapFixture instead")
