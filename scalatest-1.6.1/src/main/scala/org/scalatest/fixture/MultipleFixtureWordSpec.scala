...
/**
 * <b>MultipleFixtureWordSpec has been deprecated and will be removed in a future version of ScalaTest.
 * Please use FixtureWordSpec with ConfigMapFixture instead.</b>
 *
 * <p>
 ...
 * just change "MultipleFixtureWordSpec" to "FixtureWordSpec with ConfigMapFixture" in your code. - Bill Venners
 * </p>
 */
@deprecated("Use FixtureWordSpec with ConfigMapFixture instead")
