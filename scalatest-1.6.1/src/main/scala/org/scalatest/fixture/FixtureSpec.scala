 ...
 *
 * <p>
 * The purpose of <code>FixtureSpec</code> and its subtraits is to facilitate writing tests in
 ...
 *
 * <p>
 * Trait <code>FixtureSpec</code> behaves similarly to trait <code>org.scalatest.Spec</code>, except that tests may have a
 ...
 *
 * class StackSpec extends FixtureSpec {
 *
 ...
 *
 *  class ExampleSpec extends FixtureSpec with ConfigMapFixture {
 *
 ...
 *
 * <p>
 * If different tests in the same <code>FixtureSpec</code> need different shared fixtures, you can use the <em>loan pattern</em> to supply to
 ...
 * import collection.mutable.Stack
 *
 * class StackSpec extends FixtureSpec with ConfigMapFixture {
 *
