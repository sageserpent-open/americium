...
/**
 * <b>MultipleFixturePropSpec has been deprecated and will be removed in a future version of ScalaTest.
 * Please use FixturePropSpec with ConfigMapFixture instead.</b>
 *
 * <p>
 ...
 * just change "MultipleFixturePropSpec" to "FixturePropSpec with ConfigMapFixture" in your code. - Bill Venners
 * </p>
 */
@deprecated("Use FixturePropSpec with ConfigMapFixture instead")
