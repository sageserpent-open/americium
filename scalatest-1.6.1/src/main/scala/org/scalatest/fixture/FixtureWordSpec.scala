 ...
 *
 * <p>
 * The purpose of <code>FixtureWordSpec</code> and its subtraits is to facilitate writing tests in
 ...
 *
 * <p>
 * Trait <code>FixtureWordSpec</code> behaves similarly to trait <code>org.scalatest.WordSpec</code>, except that tests may have a
 ...
 *
 * class StackSpec extends FixtureWordSpec {
 *
 ...
 *
 *  class ExampleSpec extends FixtureWordSpec with ConfigMapFixture {
 *
 ...
 *
 * <p>
 * If different tests in the same <code>FixtureWordSpec</code> need different shared fixtures, you can use the <em>loan pattern</em> to supply to
 ...
 * import collection.mutable.Stack
 * 
 * class StackSpec extends FixtureWordSpec with ConfigMapFixture {
 * 
