...
/**
 * <b>MultipleFixtureSpec has been deprecated and will be removed in a future version of ScalaTest.
 * Please use FixtureSpec with ConfigMapFixture instead.</b>
 *
 * <p>
 ...
 * just change "MultipleFixtureSpec" to "FixtureSpec with ConfigMapFixture" in your code. - Bill Venners
 * </p>
 */
@deprecated("Use FixtureSpec with ConfigMapFixture instead")
