...
/**
 * <b>MultipleFixtureFreeSpec has been deprecated and will be removed in a future version of ScalaTest.
 * Please use FixtureFreeSpec with ConfigMapFixture instead.</b>
 *
 * <p>
 ...
 * just change "MultipleFixtureFreeSpec" to "FixtureFreeSpec with ConfigMapFixture" in your code. - Bill Venners
 * </p>
 */
@deprecated("Use FixtureFreeSpec with ConfigMapFixture instead")
