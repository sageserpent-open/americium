...
// Commented out as this causes the Scala 3.1.1 compiler to fault with an internal assertion failure.

//  "test driving automatic implicit generation of a trials for a recursive data structure" should "not produce smoke" in {
//    {
//      // TODO: see if the workaround can be ditched once the Scala 3 compiler error has been fixed.
//      val workaround: Factory[List[Boolean]] = Factory.autoDerived
//
//      workaround.trials
//        .withLimit(limit)
//        .supplyTo(println)
...
//    {
//      // TODO: see if the workaround can be ditched once the Scala 3 compiler error has been fixed.
//      val workaround: Factory[BinaryTree] = Factory.autoDerived
//
//      workaround.trials
//        .withLimit(limit)
//        .supplyTo(println)
