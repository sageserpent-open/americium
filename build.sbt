...
lazy val americium: Project = (project in file("core-library"))
  ...
  .settings(
    ...
    libraryDependencies += "org.mockito" % "mockito-junit-jupiter" % "5.23.0" % Test,
...
lazy val `americium-junit5`: Project = (project in file("junit5-integration"))
  ...
  .settings(
    ...
    libraryDependencies += "org.junit.platform" % "junit-platform-launcher" % "1.14.4",
    libraryDependencies += "org.junit.jupiter" % "junit-jupiter-params" % "6.1.1",
